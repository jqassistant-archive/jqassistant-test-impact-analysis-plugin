...
The plugin is available from Maven Central repository and can be enabled by adding it as a dependency to the jQAssistant Maven plugin:
...
<profiles>
    <profile>
        <id>create-commit-testsuite</id>                                                 <!-- <3> -->
        <build>
            <plugins>
                <plugin>
                ...
                <plugin>
                    ...
                    <configuration>
                        <concepts>
                            <concept>testsuite:SurefireSuiteForLastGitCommit</concept>   <!-- <4> -->
                        </concepts>
                    </configuration>
                </plugin>
            </plugins>
    ...
    <profile>
        <id>create-branch-testsuite</id>                                                 <!-- <5> -->
        <build>
            <plugins>
                <plugin>
                    <groupId>org.apache.maven.plugins</groupId>
                ...
                <plugin>
                    ...
                    <configuration>
                        <concepts>
                            <concept>testsuite:SurefireSuiteForCurrentBranch</concept>
                        </concepts>
                    </configuration>
                </plugin>
            </plugins>
...
<3> Defines the profile to be used for creating a test suite based on the last Git commit
<4> Activates the concept `testsuite:SurefireSuiteForLastGitCommit`
<5> Defines the profile to be used for creating a test suite based on the commits within the current Git branch
<6> Activates the concept `testsuite:SurefireSuiteForCurrentBranch`
...
The following command triggers a build which only executes the tests which are defined in the test suite files.
